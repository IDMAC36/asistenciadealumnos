        ...
        <form method="POST" action="{{ route('staff.update', $staff) }}" class="p-6 space-y-5">
            ...
            <div>
                ...
                <input type="text"
                       name="dpi"
                       id="dpi"
                       value="{{ old('dpi', $staff->dpi) }}"
                       required
                       class="w-full rounded-lg border border-gray-300 px-4 py-2.5 text-sm focus:ring-2 focus:ring-yellow-500 focus:border-yellow-500 outline-none @error('dpi') border-red-500 @enderror"
